/****************************************************************************
** Meta object code from reading C++ file 'QThreadWrap.h'
**
...
#error "The header file 'QThreadWrap.h' doesn't include <QObject>."
...
static const char qt_meta_stringdata_Thread[] = {
    "Thread\0\0SArg1\0CallFunc(QString*)\0"
};
...
void Thread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->CallFunc((*reinterpret_cast< QString*(*)>(_a[1]))); break;
        default: ;
        }
    }
}
...
// SIGNAL 0
void Thread::CallFunc(QString * _t1)
{
