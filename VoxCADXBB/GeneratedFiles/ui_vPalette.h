...
public:
    ...
    void setupUi(QWidget *PaletteDlg)
    {
        ...
        sizePolicy.setHeightForWidth(StrainFailRadio->sizePolicy().hasHeightForWidth());
        StrainFailRadio->setSizePolicy(sizePolicy);
        ...
        sizePolicy1.setHeightForWidth(Mat1SelCombo->sizePolicy().hasHeightForWidth());
        Mat1SelCombo->setSizePolicy(sizePolicy1);
        ...
        sizePolicy1.setHeightForWidth(Mat2SelCombo->sizePolicy().hasHeightForWidth());
        Mat2SelCombo->setSizePolicy(sizePolicy1);
        ...
        scrollAreaWidgetContents->setGeometry(QRect(0, 0, 302, 269));
    ...
    {
        PaletteDlg->setWindowTitle(QApplication::translate("PaletteDlg", "vPalette", 0, QApplication::UnicodeUTF8));
