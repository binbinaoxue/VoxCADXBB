...
vPalette::vPalette(QVX_Object* pObjIn, QWidget *parent)
	: QWidget(parent)
{
...
//	Palette_Model.pObj = pObj; //connect our model to our object
	...
	TmpEditDlg = new vStructureEditor(&TmpEdit, NULL); //shouldn't ever casue me leaks...
...
void vPalette::AddMaterial(void)
{
...
void vPalette::DeleteCurMaterial(void)
{
...
void vPalette::LoadPalette(void)
{
	pObj->OpenPal();
...
void vPalette::SavePalette(void)
{
	pObj->SavePal();
}

void vPalette::GetCurMat(int* MatIndex)
{
...
void vPalette::ChangedG(int GVal)
{
	int CurMat = GetCurMat();
...
void vPalette::ChangedB(int BVal)
{
	int CurMat = GetCurMat();
...
void vPalette::ChangedA(int AVal)
{
	int CurMat = GetCurMat();
...
void vPalette::MatModeChanged(int NewMatMode)
{
...
void vPalette::Mat1IndexChanged(int NewMatIndex)
{
...
void vPalette::Mat2IndexChanged(int NewMatIndex)
{
	if (NewMatIndex>=0 && NewMatIndex != GetCurMat() && MatIsEditable(NewMatIndex)){ //filter for selecting anything not allowed, since its a pain to disable in QComboBox
...
void vPalette::ChangedPercRand(int RVal)
{
	int CurMat = GetCurMat();
...
void vPalette::ChangedXDim(int XDimVal)
{
...
void vPalette::ChangedXOff(int XOffVal)
{
	GetPCurMat()->SetSubXOffset(XOffVal);
	emit RequestUpdateGL();
}

void vPalette::ChangedYDim(int YDimVal)
{
...
void vPalette::ChangedYOff(int YOffVal)
{
	GetPCurMat()->SetSubYOffset(YOffVal);
	emit RequestUpdateGL();
}

void vPalette::ChangedZDim(int ZDimVal)
{
...
void vPalette::ChangedZOff(int ZOffVal)
{
	GetPCurMat()->SetSubZOffset(ZOffVal);
	emit RequestUpdateGL();
}

void vPalette::ClickedEditStructure(void)
{
...
bool vPalette::MatIsEditable(int MatIndex, std::string* ModName) //check for self reference, recursion...
{
...
void vPalette::DoneEditStructure(void)
{
	GetPCurMat()->GetStructure() = TmpEdit.Structure;
	emit RequestUpdateGL();
}

void vPalette::ClickedImport(void) //does not currently support material recursion within the imported VXC (flattens it)
{
	QVX_Object tmpObj;
	std::string RetMsg;
	tmpObj.Open();
...
void vPalette::ClickedExport(void) //does not currently support material recursion within the exported VXC (flattens it)
{
	QVX_Object tmp;
...
void vPalette::UpdateFields(void) //updates window based on current material selection, etc.
{
	int CurMat = GetCurMat();
...
void vPalette::UpdateVisibleTabs(void)
{
...
void vPalette::ImportSSData(void)
{
